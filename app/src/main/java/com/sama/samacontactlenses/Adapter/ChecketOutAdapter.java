...
public class ChecketOutAdapter extends RecyclerView.Adapter<ChecketOutAdapter.ViewHolder> {
    Activity activity;
    public ArrayList<HashMap<String, String>> map_list;

    public ChecketOutAdapter(Activity activity, ArrayList<HashMap<String, String>> map_list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.chetout_item, parent, false);
